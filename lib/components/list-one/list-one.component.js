...
var ListOneComponent = (function (_super) {
     ...
     * @inheritDoc
     */
    ListOneComponent.prototype.ngOnInit = function () {
        if (this.value) {
            this.setTextByKey();
        }
    };
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], ListOneComponent.prototype, "value", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], ListOneComponent.prototype, "valueChange", void 0);
ListOneComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: "c-list-one",
